...
public class ZipUtils2
{
	public static void unzip()
	{
		...
		String path2 = BaseUtils.getAssetsDir().getAbsolutePath() + File.separator;
		String file = path + "bin" + File.separator + "assets.zip";
		...
		for (int i = 0; i < zipentry.size(); i++)
		{
			...
			extractFromZip(file, path2, ze.getName(), zipfile, ze);
		}
